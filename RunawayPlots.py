...
def plotSTILTS(avg_l, avg_b, avg_pml, avg_pmb, min_yso, max_age, aux_max = 1e9, align_threshold = 0.2, l = 'l'): #combine max_age and aux_max
...
# Factor of 2 for travel time and for age itself
# Regions within a kiloparsec\
# Use labels
# Consider scaling alignment tolerance with sd of position
# add uncertainties of regions and stars in quadrature, 1sigma